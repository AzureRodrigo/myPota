...
- (UIView *)showPos:(CGPoint)center backGround:(BOOL)background corner:(float)corner
{
    dialogView = [self createContainerViewCustom:background corner:corner];
...
- (UIView *)createContainerViewCustom:(BOOL)background corner:(float)corner
{
