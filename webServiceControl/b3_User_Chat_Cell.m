...
@implementation b3_User_Chat_Cell
...
+(CGSize)messageSize:(NSString*)message {
    return [message sizeWithFont:[UIFont systemFontOfSize:messageTextSize] constrainedToSize:CGSizeMake([b3_User_Chat_Cell maxTextWidth], CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
}
...
- (void)layoutSubviews {
    ...
    CGSize textSize = [b3_User_Chat_Cell messageSize:self.messageLabel.text];
    
    /*Calculates the size of the timestamp.*/
    CGSize dateSize = [self.timeLabel.text sizeWithFont:self.timeLabel.font forWidth:[b3_User_Chat_Cell maxTextWidth] lineBreakMode:NSLineBreakByClipping];
    ...
    self.balloonView.image = [b3_User_Chat_Cell balloonImage:self.sent isSelected:self.selected];
